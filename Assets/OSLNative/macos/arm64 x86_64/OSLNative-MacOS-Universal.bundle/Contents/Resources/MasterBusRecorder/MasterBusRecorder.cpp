...
///
/// Please note that the plugin only works if "Load at startup" is checked in the Import settings in Unity for the OSLNative library (.so, .dll, .dylib, .a or .bundle) and that you have to set this for each platform individually.
