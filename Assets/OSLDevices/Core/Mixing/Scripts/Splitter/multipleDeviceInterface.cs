...
public class multipleDeviceInterface : deviceInterface
{
    ...
    public override void Awake()
    {
        ...
        setFlow(); // reads the prefab default to select mixer or splitter flow
    }
    ...
    public override InstrumentData GetData()
    {
        ...
        setDeviceType(data); // Splitter and MixerOne share this data type, so resolution falls back to the prefab root name.
