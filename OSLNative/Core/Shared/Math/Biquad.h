...
/* Biquad is OSL's shared utility filter core.
 It follows the RBJ Audio EQ Cookbook transfer functions for runtime filtering paths where predictable EQ behavior
 matters more than synth character.
 ...
 2. Repeatedly call the processing routine:
    Biquad_process(biquad, BIQUAD_LOWPASS, 500, 1.0, 1.0, 48000, buffer, buffer, buffer.Length);
