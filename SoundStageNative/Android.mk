...
LOCAL_SRC_FILES := main.cpp util.c Filter.cpp Compressor.cpp RingBuffer.cpp CRingBuffer.cpp Delay.cpp StereoVerb.cpp resample.cpp Artefact.cpp $(MASTERBUSRECORDER_SOURCES) $(FREEVERB_SOURCES:$(LOCAL_PATH)/%=%)
LOCAL_LDLIBS    := -llog
