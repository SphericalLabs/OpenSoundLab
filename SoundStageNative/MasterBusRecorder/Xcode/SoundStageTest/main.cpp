...
void ExpCurveTest(int iterations)
{
    ...
    for(int i = 0; i < iterations; i++)
    {
        while(x <= 1) //Take care, float values will often be something like 1.0000034, which makes the loop terminate earlier than you would except...
        {
            printv("%f\n", _expCurve(x, ym));
            x += grid;
        }
...
void MapTest(int iterations)
{
    ...
    for(int i = 0; i < iterations; i++)
    {
        while(x <= stop1) //Take care, float values will often be something like 1.0000034, which makes the loop terminate earlier than you would except...
        {
